  ...
  const labs = [
    {
      ...
      phone: "+91-9876543210",
      rating: 4.8,
      services: ["Complete Soil Analysis", "Door Pickup", "Quick Results"],
      price: "₹300"
    },
    {
      name: "AgriTech Labs",
      ...
      phone: "+91-9876543211",
      rating: 4.7,
      services: ["Advanced Testing", "Digital Reports", "Expert Consultation"],
      price: "₹450"
    },
    {
      name: "Bharat Soil Center",
      location: "Bangalore",
      phone: "+91-9876543212", 
      rating: 4.6,
      services: ["Organic Analysis", "Same Day Pickup", "Farmer Support"],
      price: "₹250"
    }
  ];
                ...
                <Card key={index} className="hover:shadow-md transition-smooth">
                  <CardHeader>
                    <div className="flex justify-between items-start">
                      ...
                      <Badge variant="secondary">⭐ {lab.rating}</Badge>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
